...
namespace Assert
  ...
  simplePosAssert = checkGivenOutput expected prop where
    prop : Property
  ...
  simpleNegAssert = checkGivenOutput expected prop where
    prop : Property
...
namespace NoShrinkGen
  ...
  simplePosGeneration = checkGivenOutput expected prop where
    prop : Property
    prop = property $ do
  ...
  simpleNegGeneration = recheckGivenOutput expected prop 22 seed where
    seed : Seed
